...
def driver(request):
    ...
    executor_url = "http://192.168.167.1:4444/wd/hub"
...
def pytest_addoption(parser):
    ...
    parser.addoption("--remote-url", action="store", default="http://192.168.31.119:4444/wd/hub", help="remote URL for Selenoid")